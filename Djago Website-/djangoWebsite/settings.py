...
PROJECT_DIR=  os.path.join(BASE_DIR,"djangoWebsite")
...
SECRET_KEY = 'o&*_+zt1)i@44ab03)w8*ppqd%hv4$zn5vkd%4ns--@3#=s5t+'
...
TEMPLATES = [
    {
        ...
        # there is a project directory called templates inside PROJECT_DIR folder
